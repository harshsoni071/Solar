        ...
        <div className="px-3 py-5">
          ...
          <div className="bg-gray-600 p-5 mx-2 mt-4 rounded-[15px]">
            ...
            <div className="text-center pt-6 pb-4">
              <button className="bg-black text-white py-[10px] rounded-[14px] px-7 hover:bg-blue-600 hover:font-semibold hover:text-black">Submit Ticket</button>
            </div>
          </div>
        </div>
